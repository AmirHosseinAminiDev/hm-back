                   ...
                   {{ $question['category_name'] ?? '' }}
                        ...
                        <div class="p-4 flex flex-wrap items-center gap-y-4">
                            ...
                            <div
                                ...
                                <a href="#" class="text-[#A8ABB4] dark:text-[#84858F]">{{ $question['answers_count'] ?? 0 }} پاسخ </a>
                            </div>
                            <div
                                class="px-4 flex items-center gap-1 text-sm border-l border-[#ECEEF3] dark:border-[#191B21] min-w-max">
                                <div>
                   ...
                   {{ $questionItem['category_name'] ?? '' }}
                            ...
                            <div class="p-4 flex items-center flex-wrap gap-y-4">
                                <div
                                    class="px-4 flex items-center gap-1 text-sm border-l border-[#ECEEF3] dark:border-[#191B21] min-w-max">
                                    <img class="w-6 h-6 rounded-full" src="{{ asset('images/profile.png') }}" alt="profile">
                                    <a href="#" class="text-[#20D05C] dark:text-[#FFC700]">{{ $questionItem['author'] ?? '' }}</a>
                                </div>
                                <div
                                    class="px-4 flex items-center gap-1 text-sm border-l border-[#ECEEF3] dark:border-[#191B21] min-w-max">
                                    <div>
                                    ...
                                    <a href="#" class="text-[#A8ABB4] dark:text-[#84858F]">{{ $questionItem['answers_count'] ?? 0 }} پاسخ </a>
                                </div>
                                <div
                                    class="px-4 flex items-center gap-1 text-sm border-l border-[#ECEEF3] dark:border-[#191B21] min-w-max">
                                    <div>
                                    ...
                                    <a href="#" class="text-[#A8ABB4] dark:text-[#84858F] ">{{ $questionItem['votes_count'] ?? 0 }} رای </a>
                                </div>
                                <div class="px-4 flex items-center gap-1 text-sm min-w-max">
                                    ...
                                    <a href="#" class="text-[#A8ABB4] dark:text-[#84858F]">{{ $questionItem['views'] ?? 0 }} بازدید</a>
                                </div>
                            </div>
                        </div>
                    @if($loop->iteration == 1)
