                    ...
                    <div class="flex flex-col gap-7 border-b pb-10">
                        <div class="w-full">
                            <div class="flex  gap-3 overflow-x-hidden h-max w-full">
                                ...
                                <div class="flex flex-col justify-between items-center  w-[75%] py-2 ">
                                    <div class="flex truncate items-center w-full text-xs ">
                                        <a href="#" class="text-[#0F0F0E] dark:text-[#FCFCFC] truncate  text-sm">مبلغ
                                            بیعانه برای اجاره
                                            خانه
                                            بر چه مبنایی تعیین میشه؟</a>
                                    </div>
            ...
            <div class="flex flex-col gap-[23px]">
                <div class="flex flex-col gap-2">
                    ...
                    <select
                        ...
                        <option value="1" selected=""> انتخاب دسته بندی</option>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div
                        ...
                        <textarea class="!relative !border-0" name="editor" id="editor"></textarea>
